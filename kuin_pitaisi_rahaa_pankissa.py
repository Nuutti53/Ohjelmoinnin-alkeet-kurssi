def tallenna_summat(tallennettava_data, kohdetiedoston_nimi):
    try:
        with open(kohdetiedoston_nimi, "w") as kohde:
            for data in tallennettava_data:
                kohde.write(f"{':'.join(data)}\n")
    except IOError:
